...
- 🖥️ **La cancha de Posiciones ahora se toca.** Era un dibujo con globitos que solo aparecían pasando el ratón: en el teléfono no se podía hacer nada. Ahora cada posición es un botón — tócala y te dice quién la juega hoy, cuántos son y qué media tiene esa línea. **Y lo divertido: puedes ver cómo rendiría ahí cualquiera de la plantilla.** El overall ya se calcula distinto según la línea —a un central le pesa más marcar que rematar—, así que la reta se entera de que su delantero daría cinco puntos más jugando de defensa. Las posiciones que no cubre nadie salen con el borde punteado, para ver de un vistazo dónde vas en cuadro.
...
- 🖥️ **Tu foto entra contigo al registrarte.** El formulario de _Únete a la reta_ ya deja subir una foto: se elige, se ve al momento y se optimiza sola antes de enviarse, así que da igual que sea una foto de teléfono de cinco megas. En cuanto hay foto el selector desaparece y queda la vista previa con _Cambiar_ y _Quitar_, para que no quede la duda de si se guardó. **Y es la misma foto que después lleva tu ficha**: cuando un admin te da de alta, la reutiliza tal cual en vez de pedirte otra.

- 🖥️ **Registrarse ahora pide cuenta, y crearla no te saca de la página.** Antes de los datos sale una pantalla que explica en tres líneas por qué hace falta: tu ficha queda a tu nombre desde el primer día, puedes subir tu foto, y nos ahorra solicitudes repetidas. _Crear cuenta_ abre el registro de Clerk encima de la misma vista; al cerrarlo, el formulario aparece ahí mismo sin recargar ni perder el sitio.

- 🖥️ **Ves tu carta mientras te registras.** Al lado del formulario aparece la carta con la que entrarás a la plantilla, y va cambiando según escribes: tu apodo, tus posiciones y tu foto en cuanto la subes, con la barra de la subida encima mientras se optimiza. **El OVR sale como un guion y el marco es gris**, no bronce: todavía nadie te ha valorado, y un número ahí sería inventado. Debajo lo dice: cuando un admin te dé de alta, la carta estrena color —bronce, plata u oro—.

### 🔧 Mejoras

- 🖥️ **Elegir posición ya no es buscar a ciegas en una lista de quince.** En el registro y en el alta, el desplegable de posición principal y secundaria se cambia por un buscador: escribes "contencion" —sin tilde, como se teclea en el teléfono— o directamente "CDM", y ahí está. Las opciones van **agrupadas por línea** —portero, defensa, mediocampo, delantero— y cada una lleva el punto de color de su línea, el mismo de la cancha. La secundaria ya no ofrece la que elegiste como principal.

- 🖥️ **El alta de jugador enseña la foto donde de verdad se ve: en la carta.** Antes la foto se quedaba en un campo del formulario y había que imaginarse cómo quedaría. Ahora entra directa en la carta FIFA de la derecha. **Si el alta viene de una solicitud, la foto que mandó el jugador ya está puesta al abrir la página** —no hay que volver a subirla ni dudar de si se guardó—, y el formulario solo lo dice en una línea. Si la subes tú, aparece en la carta desde el primer segundo, con la barra de la subida encima mientras se optimiza (la misma optimización del registro: una foto de teléfono de cinco megas deja de serlo antes de salir del navegador). La carta se inclina siguiendo el ratón y suelta un destello cada vez que cambia de foto o de categoría —bronce, plata, oro—, para que se note qué acaba de cambiar.

- 🖥️ **El formulario de registro, rehecho para el teléfono.** Era una lista larga de catorce campos seguidos donde el botón de enviar quedaba a tres pantallas de scroll. Ahora va **por bloques** —tu ficha, en la cancha, físico, contacto—, lo opcional se ve de un vistazo, altura y peso comparten fila, y **el botón de enviar se queda a la vista** mientras bajas. En pantalla grande se reparte en dos columnas y aprovecha el ancho.
