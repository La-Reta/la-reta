...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      render={render}
      // Cuando se pasa `render` (p.ej. <Button render={<Link/>}>), lo renderizado
      // no es un <button> nativo; desactivamos nativeButton para evitar el warning
      // de Base UI. Se puede sobrescribir pasando `nativeButton` explícito.
