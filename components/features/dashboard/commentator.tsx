...
export function Commentator() {
  return (
    <section className="overflow-hidden rounded-lg ring-1 ring-foreground/10 bg-[linear-gradient(120deg,#241433_0%,#150d24_55%,#0b0816_100%)] text-white">
      <div className="flex items-stretch">
        ...
        <div className="flex flex-1 flex-col justify-center gap-2.5 p-5">
          <span className="inline-flex w-fit items-center gap-1.5 rounded-full bg-rose-500/20 px-2.5 py-1 font-display text-[11px] font-semibold uppercase tracking-[0.18em] text-rose-300">
