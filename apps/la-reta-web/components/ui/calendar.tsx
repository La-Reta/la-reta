...
/**
 * `YYYY-MM-DD` a partir de la fecha local, sin `Intl`.
 *
 * Es un atributo de datos, no texto que lea nadie, y `toLocaleDateString`
 * formatea con la zona del servidor al renderizar y con la del navegador al
 * hidratar — o sea, desajuste de hidratación garantizado en algunas zonas.
 */
