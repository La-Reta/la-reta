...
const Button = ({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      // MODIFICADO respecto a shadcn: con `render` (p. ej. <Button render={<Link/>}/>)
      // el elemento final no es un <button>, y Base UI avisa en consola si
      // `nativeButton` sigue en true. Conservar al regenerar el componente.
