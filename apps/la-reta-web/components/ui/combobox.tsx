      ...
      <InputGroupAddon align="inline-end">
        {showTrigger ? (
          <InputGroupButton
            size="icon-xs"
            variant="ghost"
            // MODIFICADO respecto a shadcn: nuestro Button pone
            // `nativeButton={false}` en cuanto recibe `render`, pero
            // ComboboxTrigger SÍ renderiza un <button> nativo, y Base UI avisa
            // en consola por la discrepancia. Conservar al regenerar.
            nativeButton
