        ...
        */}
        {fontsReady ? (
          ...
          >
            ...
            {/* Hoja a media altura: el calendario es una consulta rápida, no
                una pantalla a la que se "entre". Ojo al depurarla: Fast Refresh
                no vuelve a aplicar estas opciones, así que un cambio aquí pide
                recargar la app entera antes de creerse lo que se ve. */}
            <Stack.Screen
              name="calendario"
              options={{
