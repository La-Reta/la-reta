...
async function main() {
  ...
  await db.insert(ideas).values([
    ...
    },
    {
      ...
      description:
        "Una cascarita extra entre semana, con luces, para los que no llegan al fin de semana.",
      author: "Migue",
      category: "social",
      status: "nueva",
    },
    {
      ...
      description:
        "Para que nadie se quede siempre en el arco y todos jueguen de campo.",
      category: "reglas",
      status: "en_progreso",
      priority: "baja",
    },
